                ...
                <div className="col-12 px-xl-4 pt-xl-2">
                  <div className="row my-sm-2 mx-2 align-items-baseline">
                    <div className="col-12">
                      <a href="#_" className="inner-heading-24 black-colour">
                        <i className="fas fa-arrow-left" /> Rides
                      </a>
                    </div>
                  </div>
                      ...
                      <div className="card-dashboard">
                        <div className="row ml-0 mr-0 py-2">
                          <div className="col-12 d-xl-flex align-items-center justify-content-between">
                            ...
                            <div className="d-sm-flex align-items-center justify-content-end for-select">
                              <label
                                htmlFor
                                className="mr-sm-1 dash-label mb-0"
                              >
                              ...
                              <select className="dash-select entri-drop for-width-200">
                                <option value>Select</option>
                                <option value>Completed</option>
                                <option value>Disputed</option>
                                <option value>Pending</option>
                                <option value>Cancelled by User</option>
                                <option value>Cancelled by Rider</option>
                              </select>
                            </div>
                          </div>
                        </div>
                        <div className="row ml-0 mr-0 py-2">
                          <div className="col-12 d-xl-flex align-items-center justify-content-between">
                            <div className="d-sm-flex align-items-center">
                              ...
                              <input
                                className="dash-input p-1 w-172 for-radius-10"
                                type="date"
                              />
...
export default DriverDetailsRides;
